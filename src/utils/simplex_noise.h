...
public:
    ...
    float turbulence(size_t octaves, float x) const;
    float turbulence(size_t octaves, float x, float y) const;
    float turbulence(size_t octaves, float x, float y, float z) const;
