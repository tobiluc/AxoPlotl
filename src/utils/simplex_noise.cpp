...
/**
 * Turbulence summation of 1D Perlin Simplex noise
 *
 * @param[in] octaves   number of fraction of noise to sum
 * @param[in] x         float coordinate
 *
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::turbulence(size_t octaves, float x) const {
    float output = 0.f;
    float denom = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
    ...
    for (size_t i = 0; i < octaves; i++) {
        output += std::abs(amplitude * noise(x * frequency));
        denom += amplitude;
...
/**
 * Turbulence summation of 2D Perlin Simplex noise
 *
 * @param[in] octaves   number of fraction of noise to sum
 * @param[in] x         x float coordinate
 * @param[in] y         y float coordinate
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::turbulence(size_t octaves, float x, float y) const {
    float output = 0.f;
    float denom = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
    ...
    for (size_t i = 0; i < octaves; i++) {
        output += std::abs(amplitude * noise(x * frequency, y * frequency));
        denom += amplitude;
...
/**
 * Turbulence summation of 3D Perlin Simplex noise
 *
 * @param[in] octaves   number of fraction of noise to sum
 * @param[in] x         x float coordinate
 * @param[in] y         y float coordinate
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::turbulence(size_t octaves, float x, float y, float z) const {
    float output = 0.f;
    float denom = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
    ...
    for (size_t i = 0; i < octaves; i++) {
        output += std::abs(amplitude * noise(x * frequency, y * frequency, z * frequency));
        denom += amplitude;
